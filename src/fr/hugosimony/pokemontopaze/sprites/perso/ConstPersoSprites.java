package fr.hugosimony.pokemontopaze.sprites.perso;

import javax.swing.ImageIcon;

import fr.hugosimony.pokemontopaze.Main;

public class ConstPersoSprites {
	...
	public static final ImageIcon overallsmanFrontRight = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanFrontRight.gif"));
	public static final ImageIcon overallsmanFrontLeft = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanFrontLeft.gif"));
	public static final ImageIcon overallsmanBack = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanBack.gif"));
	public static final ImageIcon overallsmanBackRight = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanBackRight.gif"));
	public static final ImageIcon overallsmanBackLeft = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanBackLeft.gif"));
	public static final ImageIcon overallsmanLeft = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanLeft.gif"));
	public static final ImageIcon overallsmanLeftRight = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanLeftRight.gif"));
	public static final ImageIcon overallsmanLeftLeft = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanLeftLeft.gif"));
	public static final ImageIcon overallsmanRight = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanRight.gif"));
	public static final ImageIcon overallsmanRightRight = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanRightRight.gif"));
	public static final ImageIcon overallsmanRightLeft = new ImageIcon(Main.class.getResource("sprites/perso/overallsman/overallsmanRightLeft.gif"));
