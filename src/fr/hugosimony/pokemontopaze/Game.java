...
public class Game extends JFrame {
	...
	public Game(boolean newGame, int save) {
		...
		BattleConst.getAnimatedSprite(new Pokemon(PKM.HERBIZARRE, "test1", Nature.ADAMANT, 2, null, 5, 0, false, 20, 20, 10, 10, 10, 10, 10, null, null, null, null, null, null, "hugo", true, 0), false);
